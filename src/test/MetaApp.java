package test;
// 本试卷唯一 ID: D62B69E6899570A49658F260C5116527, 请勿修改本行内容
/* 注意, 这里不要写包名. 留空 */
    ...
    /* qn8:
        下面代码会分别输出怎样的结果:
          public static void main(String[] args) {
              ...
              str = "真的没人比我更懂java";
              System.out.printf(map.get("str").toString()+"; ");//"没人比我更懂java";
